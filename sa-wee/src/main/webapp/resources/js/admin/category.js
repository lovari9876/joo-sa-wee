$(document).ready(function(){
	...
	$(function(){
		...
		var ARR = [
					...
					{"sub":"노하우","board":"보드이야기"},
					{"sub":"토론","board":"보드이야기"},
					{"sub":"전체보기","board":"개봉기및리뷰"},
					{"sub":"개봉기","board":"개봉기및리뷰"},
					{"sub":"일리뷰","board":"개봉기및리뷰"},
					{"sub":"다리뷰","board":"개봉기및리뷰"},
					{"sub":"전체보기","board":"보드게임모임"},
					{"sub":"모집","board":"보드게임모임"},
					{"sub":"모임후기","board":"보드게임모임"},
					{"sub":"전체보기","board":"보드뉴스"},
					{"sub":"이벤트","board":"보드뉴스"},
					{"sub":"대회","board":"보드뉴스"},
					{"sub":"신작소식","board":"보드뉴스"},
					{"sub":"세일","board":"보드뉴스"},
					{"sub":"기타","board":"보드뉴스"},
					{"sub":"전체보기","board":"질문과답변"},
					{"sub":"룰","board":"질문과답변"},
					{"sub":"추천","board":"질문과답변"},
					{"sub":"기타","board":"질문과답변"},
					{"sub":"전체보기","board":"창작보드게임"},
					{"sub":"계획","board":"창작보드게임"},
					{"sub":"디자인","board":"창작보드게임"},
					{"sub":"완성","board":"창작보드게임"},
					{"sub":"공유","board":"창작보드게임"},
					{"sub":"테스트플레이","board":"창작보드게임"},

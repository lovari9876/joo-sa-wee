				...
				<div class="container web-portion">
					...
					<div class="nav-detail">
						...
						<div class="tab-content" id="myTabContent">
							...
							<div class="tab-pane fade profile-tab JSD-Regular-12"
								id="profile" role="tabpanel" aria-labelledby="profile-tab">
								<div class="table-mypage">
									<table class="table">
										<tr class="table_row header">
											<td class="cell">글<br /> 번호
											</td>
										...
										<c:forEach items="${myScrap}" var="myScrap">
											<tr class="trow">
												...
												<td class="cell"><button
														class="scrap_delete btn btn-lavender-min btn-min"

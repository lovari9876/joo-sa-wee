			...
			<div class="module">
				...
				<div class="module-option clearfix">
					...
					<div class="btn-group pull-left" >
						<button type="button" class="btn selectDelete_btn" data-Num="${trade['T_NO']}" >선택 글 삭제</button>
						<button type="button" class="btn selectIsland_btn" data-BW="${trade['T_NO']} ${trade['M_NO']}">무인도 행</button>
					</div>
				...
				<section class="list-section">
					...
					<table class="table">
						...
						<c:forEach items="${board_list_trade}" var="trade">
								<tr class="trow">
									<td class="cell"><input type="checkbox" name="chBox" class="chBox" data-Num="${trade['T_NO']}"></td>

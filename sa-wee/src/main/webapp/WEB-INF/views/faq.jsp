...
<body id = "top"> <!-- js 적용위해 id 지정 -->
	...
	<section
		...
		<ul class="cd-faq__categories">
			<li><a
				class="cd-faq__category cd-faq__category-selected truncate_" href="#basics">Basics</a></li>
			...
			<li><a class="cd-faq__category truncate__" href="#delivery">Delivery</a></li>
		</ul>
		<!-- cd-faq__categories -->
					...
					<div class="cd-faq__content">
						<div class="text-component">
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
								Quae quidem blanditiis delectus corporis, possimus officia sint
								sequi ex tenetur id impedit est pariatur iure animi non a
								ratione reiciendis nihil sed consequatur atque repellendus fugit

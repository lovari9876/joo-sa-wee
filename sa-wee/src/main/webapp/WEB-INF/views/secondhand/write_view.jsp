				...
				<form action="trade_write" method="post" enctype="multipart/form-data">
					...
					<table class="write-table">
						...
						<tr class="row">
							<td class="cell">제목</td>
							<td class="cell">
								<input type="text" name="bw_title" placeholder="제목을 입력하세요">
							</td>
						</tr>
						...
						<tr class="row">
							...
							<td class="cell">
								<input type="text" name="bw_title" placeholder="보드게임 선택하거나 직접 입력">
							</td>
						</tr>
						...
						<tr class="row">
							<td class="cell">가격</td>
							<td class="cell">
								<input type="text" name="bw_title" placeholder="희망 가격을 입력하세요">
							</td>
						</tr>
						...
						<tr class="row">
							<td class="cell">내용</td>
							<td class="cell">
								<textarea id = "editor" name="bw_content" placeholder="판매 혹은 구매하려는 보드게임의 사진과 함께 설명을 입력하세요">
							</textarea></td>
						</tr>

			...
			<button type="submit" class="btn" id="searchBtn">
				...
				<div class=tab-table>
					...
					<ul class="tab">
						...
						<li <c:out value="${s_content eq null ? 'class = current' : ''}"/> data-tab="tab1"><button type = "button" onclick ="location.href='board_story'">전체보기</button></li>
						<li <c:out value="${s_content == '잡담' ? 'class = current' : ''}"/> data-tab="tab2" id = "잡담"><button type = "button" onclick ="location.href='board_story?s_content=잡담'" class = "select" >잡담</button></li>
						<li <c:out value="${s_content == '노하우' ? 'class = current' : ''}"/> data-tab="tab3" id = "노하우"><button type = "button" onclick ="location.href='board_story?s_content=노하우'" class= "select">노하우</button></li>
						<li <c:out value="${s_content == '토론' ? 'class = current' : ''}"/> data-tab="tab4" id = "토론"><button type = "button" onclick ="location.href='board_story?s_content=토론'" class = "select">토론</button></li>

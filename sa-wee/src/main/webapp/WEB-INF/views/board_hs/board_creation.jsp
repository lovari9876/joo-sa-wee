...
<body id="top">
			...
			<div class="wrap-table100">
				...
				<div class=tab-table>
					...
					<ul class="tab">
						...
						<li data-tab="tab2"><button type = "button" value = "1" class = "select">말머리1</button></li>
						<li data-tab="tab3"><button type = "button" value = "2" class= "select">말머리2</button></li>
						<li data-tab="tab4"><button type = "button" value = "3" class = "select">말머리3</button></li>
	...
	<script src="js/tabdata.js" type="text/javascript"></script>
